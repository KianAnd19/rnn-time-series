...
if __name__ == '__main__':
    ...
    parallelCoordinatesPlot(ynames=ynames, data=[y1, y2, y3, y4, y5], category=category, N=N, title='Parallel Coordinates Plot with Legend', category_names=['Cat1', 'Cat2', 'Cat3'])
